...
folder are mapped to the application's root namespace, 'EmergenceContentEditor'. This is set in
`"app.json"`:

    "sass": {
        "namespace": "EmergenceContentEditor"
    }
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'EmergenceContentEditor' in the same way
as `"EmergenceContentEditor/sass/src"`.
