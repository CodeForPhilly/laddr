...
Laddr\Project::$stageDescriptions = [
    'Commenting' => _('Initial status for project, it\'s an idea people are commenting on'),
    'Bootstrapping' => _('People and resources are being recruited to start'),
    'Prototyping' => _('Something is being built'),
