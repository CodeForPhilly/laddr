...
class http_class
{
	...
	class ReCaptcha {
		...
		public static function widget() {			
			...
			<div class="g-recaptcha" data-sitekey="<?php echo static::$sitekey ?>"></div>
            
			
			<?php
		}
		
		public static function verify($response = null, $ip_address = null) {
			global $Html;
			...
			$args = array(
    			...
    			$error = $http -> GetRequestArguments('https://www.google.com/recaptcha/api/siteverify', $arguments);
		...
		public function error_message($error_code = null) {
